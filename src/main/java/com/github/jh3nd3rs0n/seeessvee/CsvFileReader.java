...
public final class CsvFileReader {
	 ...
	 * character.
	 * 
	 * @throws CsvFileReaderException if the double quote character is the first 
	 * double quote character to appear after the start of the field
	 */
	 ...
	 * 
	 * A {@code CsvFileReaderException} is thrown if the current character is 
	 * not escaped in double quotes or is not followed by a line feed character.
	 * 
	 ...
	 * stripped of enclosing double quote characters and double quote characters 
	 * escaping other double quote characters. An empty {@code List} is returned 
	 * if there are no more CSV records.
	 * 
	 * @return a CSV record as a {@code List} of fields as {@code String}s or an 
	 * empty {@code List} if there are no more CSV records
	 * 
	 * @throws IOException if an I/O error occurs 
	 */
